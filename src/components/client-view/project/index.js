        ...
        <div className="flex flex-col justify-center items-center row-start-2 sm:row-start-1">
          <h1 className="leading-[70px] mb-4 text-3xl lg:text-4xl xl:text-5xl font-medium">
            {"My Projects".split(" ").map((item, index) => (
              <span className={`${index === 1 ? "text-color" : "text-[#000]"}`}>
                {item}{" "}
              </span>
            ))}
          </h1>
          ...
          {data && data.length
            ? data.map((item, index) => (
                <li
                  ...
                  key={index}
                >
                  <div className="border-2 w-full relative border-color transition-all rounded-lg flex flex-col">
                            ...
                            {item?.technologies &&
                              item.technologies
                                ...
                                .map((techItem, index) => (
                                  ...
                                  >
                                    <button className="whitespace-nowrap text-ellipsis overflow-hidden py-3 w-[120px]  px-6 border-[2px] boder-color bg-[#fff] text-[#000] font-semibold rounded-lg text-xs tracking-widest hover-color transition-all outline-none">
                                      {techItem}
                                    </button>
                                  </div>
                                ))}
                    ...
                    <div className="absolute w-full bottom-0 justify-center flex gap-2">
                      <button
                        ...
                        className="p-2 text-white-500 font-semibold text-[14px] tracking-widest color transition-all outline-none"
                      >
                        Website
                      </button>
                      <button
