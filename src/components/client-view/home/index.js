...
const socialIcons = [
  {
    id: "facebook",
    icon: <FaFacebookF color="#915ffe" className="w-[40px] h-[40px] " />,
  },
  {
    id: "twitter",
    icon: <FaTwitter color="#915ffe" className="w-[40px] h-[40px] " />,
  },
  {
    id: "linkedin",
    icon: <FaLinkedinIn color="#915ffe" className="w-[40px] h-[40px] " />,
  },
  {
    id: "instagram",
    icon: <FaInstagram color="#915ffe" className="w-[40px] h-[40px] " />,
  },
];
...
export default function ClientHomeView({ data }) {
  ...
  return (
    <div
      className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto bgColor"
      id="home"
    >
      <AnimationWrapper>
        <motion.div
        ...
        >
          <div className="flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              {data && data.length
                ? data[0]?.heading
                    ...
                    .map((item, index) => (
                      <span
                        className={`${
                          index === 2 || index === 3 ? "text-color" : "bgColor"
                        }`}
                      >
                        {item}{" "}
                      </span>
            ...
            <p className="bgColor mt-4 mb-8 font-bold">
          ...
          <motion.div ref={containerRef} className="flex w-full justify-end">
            <motion.div
              ...
              className="w-[400px] h-[400px] relative color"
            >
