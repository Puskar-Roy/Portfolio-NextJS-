            ...
            <div className="flex flex-col justify-center items-center row-start-2 sm:row-start-1">
              <h1 className="leading-[70px] mb-4 text-3xl lg:text-4xl xl:text-5xl font-medium">
                {"My Experince".split(" ").map((item, index) => (
                  <span className={`${index === 1 ? "text-color" : "bgColor"}`}>
                    {item}{" "}
                  </span>
                ))}
              </h1>
                    ...
                    ? experienceData.map((experienceItem) => (
                        <TimelineItem>
                          <TimelineSeparator>
                            ...
                            <TimelineConnector className="color" />
                          </TimelineSeparator>
                          <TimelineContent>
                            <div className="border-[2px] p-4 rounded-[8px] border-color mt-[14px] ml-[16px]">
                  ...
                  {educationData && educationData.length
                    ? educationData.map((educationItem) => (
                        <TimelineItem>
                          ...
                          <TimelineContent>
                            <div className="border-[2px] p-4 rounded-[8px] boder-color mt-[14px] ml-[16px]">
